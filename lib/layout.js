...
export function getLayout(collectionName) {
...
export function saveLayout(collectionName, layout) {
  const layoutPath = getLayoutPath(collectionName);
 ...
 */
export function initLayoutFromLayers(collectionName, layers) {
 ...
 */
export function getLayerPosition(layout, layerName, layer) {
  if (layout[layerName]) {
 ...
 */
export function updateLayerPosition(collectionName, layerName, position) {
 ...
 */
export function updateLayerLock(collectionName, layerName, lockType, value) {
  const layout = getLayout(collectionName);
  if (!layout[layerName]) {
