...
export function weightedRandomPick(traits) {
...
export function getEstimatedTraitCounts(traits, supply) {
...
export function getRarityTier(weight) {
...
export function getRarityColor(weight) {
