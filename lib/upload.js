...
export async function uploadToPinata(dirPath, options = {}, onProgress) {
...
export async function uploadToR2(dirPath, options = {}, onProgress) {
...
export async function uploadToCustomServer(dirPath, options = {}, onProgress) {
...
export async function uploadFiles(dirPath, storageConfig) {
 ...
 */
export function generateMetadataWithUrls(project, imageBaseUrl, outputDir, cidMap = {}) {
 ...
 * Save upload report
 */
export function saveUploadReport(outputDir, report) {
 ...
 */
export function generateFinalReport(outputDir, report, cidMap = {}) {
  const lines = [];
  const sep = '═'.repeat(50);
